...
> A learn-by-doing Linux handbook — 23 modules, hundreds of drills.

---

## What is this

23 modules + 3 cheatsheets, each authored as Markdown (for browsing here on GitHub) and rendered to a polished standalone HTML page (open `index.html` in any browser — no build step). Each module covers:
...
`reference/setup-sample-data.sh` creates the practice files (`~/linux-sandbox/`) every drill references. Run it once on whatever Linux box you'll practice on.
...
| 01 | [Shell access & SSH](01-shell-and-ssh.md) |
| 02 | [Filesystem navigation](02-filesystem-navigation.md) |
| 03 | [Listing & file operations](03-listing-and-files.md) |
| 04 | [File globbing](04-file-globbing.md) |
| 05 | [Viewing text files](05-viewing-text.md) |
| 06 | [The vi/vim editor](06-vi-editor.md) |
| 07 | [Permissions](07-permissions.md) |
| 08 | [Redirection & pipes](08-redirection-pipes.md) |
...
| # | Module |
|---|---|
| 09 | [grep & regular expressions](09-grep-and-regex.md) |
| 10 | [find & xargs](10-find-and-xargs.md) |
| 11 | [Processes & jobs](11-processes-and-jobs.md) |
| 12 | [Text-processing toolbox](12-text-toolbox.md) |
| 13 | [sed & awk](13-sed-and-awk.md) |
...
| # | Module |
|---|---|
| 14 | [Shell scripting](14-shell-scripting.md) |
| 15 | [Environment & startup](15-env-and-startup.md) |
| 16 | [Users & admin](16-users-and-admin.md) |
| 17 | [Services & systemd](17-services-systemd.md) |
| 18 | [Networking basics](18-networking.md) |
| 19 | [SSH keys & 2FA](19-ssh-keys-and-2fa.md) |
| 20 | [git for sysadmins](20-git-basics.md) |
| 21 | [cron & scheduling](21-cron-and-scheduling.md) |
| 22 | [Logs & troubleshooting](22-logs-and-troubleshooting.md) |
